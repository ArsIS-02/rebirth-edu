                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Жалоба на изображения</li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive m-t-20">
                                            ...
                                            <table class="table stylish-table">
                                                ...
                                                <thead>
                                                <tr>
                                                    <th colspan="2">От пользователя</th>
                                                    <th>К Фото</th>
                                                    <th>Причина</th>
                                                    <th>Дата</th>
                                                </tr>
    ...
    function draw($item)
    {
        ?>
            ...
            <tr>
                ...
                <td>
                    <h6><a href="/admin/photo?id=<?php echo $item['itemId']; ?>">Смотреть фото</a></h6>
                </td>
                <td>
                    <?php
