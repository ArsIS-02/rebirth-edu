                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Элементы пользователя</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Элементы Пользователя</h4>
                                    </div>
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <?php
                        ...
                        if ($item['rePostId'] != 0) {
                            ...
                            ?>
                                <a target="_blank" href="/<?php echo "{$rePost['fromUserUsername']}/post/{$rePost['id']}"; ?>">См. Репост</a>
                            <?php
                ...
                <td>
                    <a href="javascript: void(0)" onclick="Post.remove('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'remove'); return false;">Удалить</a>
                </td>
            </tr>
