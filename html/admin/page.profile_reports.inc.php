                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Жалоба на Профиль</li>
                        </ol>
                    </div>
                </div>
                    ...
                    <?php
                        ...
                        switch ($item['abuseId']) {
                            ...
                            case 0: {
                                ...
                                echo "<span class=\"label label-success\">Это спам.</span>";
                            ...
                            case 1: {
                                ...
                                echo "<span class=\"label label-info\">Мат, вражда или насилие.</span>";
                            ...
                            case 2: {
                                ...
                                echo "<span class=\"label label-danger\">Порнография.</span>";
                            ...
                            default: {
                                ...
                                echo "<span class=\"label label-warning\">Фейк профиль.</span>";
