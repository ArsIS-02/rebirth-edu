                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-danger" href="javascript: void(0)" onclick="Post.remove('<?php echo $postInfo['id']; ?>', '<?php echo $postInfo['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>'); return false;">Удалить</a>
