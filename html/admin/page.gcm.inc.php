            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Отправить сообщение (FCM) для всех пользователей</li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Отправка push-уведомлений (FCM) недоступна в режиме демонстрационной версии. Мы отключили отправку push-уведомлений (FCM) в режиме демонстрационной версии, чтобы защитить пользователей от спама и нецензурной лексики.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Отправить Пуш Уведомление</h4>
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/gcm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type">
                                            <option selected="selected" value="<?php echo GCM_NOTIFY_SYSTEM; ?>">Для всех юзеров</option>
                                            <option value="<?php echo GCM_NOTIFY_CUSTOM; ?>">Только для авторизованных юзеров</option>
                                        </select>
                                    </div>
                    ...
                    if ($inbox_loaded != 0) {
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Недавно отправленные сообщения</h4>
                        ...
                        ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <h4 class="card-title">Ничего нет ((</h4>
