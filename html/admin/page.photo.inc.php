                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-danger" onclick="Photo.remove('<?php echo $photoInfo['id']; ?>', '<?php echo $photoInfo['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>'); return false;" href="javascript: void(0)">Удалить</a>
