				...
				<div class="row page-titles">
					<div class="col-md-5 col-8 align-self-center">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Стрим</li>
						</ol>
					</div>
				</div>
				...
				<div class="sl-right">
					<div>
							...
							<div class="col-md-9 col-xs-12">
                                ...
                                <?php
                                    ...
                                    if ($item['rePostId'] != 0) {
                                        ...
                                        ?>
                                            <a target="_blank" class="btn btn-success" href="/<?php echo "{$rePost['fromUserUsername']}/post/{$rePost['id']}"; ?>">Посмотреть репост</a>
                                        <?php
						...
						<div class="like-comm m-t-20">
                            <a class="link m-r-10" href="javascript: void(0)" onclick="Post.remove('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'remove'); return false;">Удалить</a>
                            <a class="link m-r-10" href="javascript: void(0)" onclick="Post.remove('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'removeByIp'); return false;">Удалить всё с этим IP</a>
                            <a class="link m-r-10" href="javascript: void(0)" onclick="Stoplist.action('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'add'); return false;">Добавить IP в Stoplist</a>
                            <a class="link m-r-10" href="javascript: void(0)" onclick="Stoplist.action('<?php echo $item['id']; ?>', '<?php echo $item['fromUserId']; ?>', '<?php echo admin::getAccessToken(); ?>', 'remove'); return false;">Удалить IP из Stoplist</a>
						</div>
                    </div>
                </div>
            </div>
