                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Поиск пользователей и сообществ</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            <h4 class="card-title">Поиск пользователей и сообществ</h4>
                            <h6 class="card-subtitle">Поис пользователей/по группам, полное имя, email. Мин. 3 символа.</h6>
                            <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="submit" class="btn btn-info" type="button">Поиск</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        if (strlen($query) < 3) {
                                ...
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Введите в поиске имя пользователя, группы, полное имя или email. Минимум 3 символа.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <h4 class="card-title">Результат поиска: 0</h4>
