                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Модерация фотографий профиля</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body collapse show">
                                        ...
                                        <p class="card-text">Отклонить - отправить пользователю сообщение с просьбой установить правильную фотографию. После того, как пользователь установил еще одну фотографию, его профиль снова будет отображаться здесь для повторной модерации.</p>
                                        <p class="card-text">Одобрить - профиль пользователя будет «модерирован» и будет отображаться для всех пользователей.</p>
                                    </div>
                                </div>

                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Модерация фотографий профиля</h4>
                                    </div>
                                    <div class="card-body collapse show">
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <a href="javascript:void(0)" onclick="Stream.reject('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', 'photo_reject'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Reject"><i class="ti-trash"></i> Отклонить</a>
                    <span> | </span>
                    <a href="javascript:void(0)" onclick="Stream.approve('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', 'photo_approve'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Approve"><i class="ti-check"></i> Одобрить</a>
                </td>
            </tr>
