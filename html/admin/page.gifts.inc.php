            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Добавить Подарок</h4>
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/gifts" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label >Цена Подарка (в монетах)</label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <button class="btn btn-info text-uppercase waves-effect waves-light" type="submit">Добавить</button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Подарки</h4>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Это значит, что нет данных для отображения</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php
    ...
    function draw($itemObj)
    {
        ...
        <tr data-id="<?php echo $itemObj['id']; ?>">
            ...
            <td><a href="/admin/gifts/?id=<?php echo $itemObj['id']; ?>&action=remove&access_token=<?php echo admin::getAccessToken(); ?>">Удалить</a></td>
        </tr>
