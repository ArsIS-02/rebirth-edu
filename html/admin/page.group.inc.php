            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="table-responsive">
                                    <table class="table color-table info-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Состояние группы:</td>
                                                <td>
                                                    <?php

                                                    if ($accountInfo['state'] == ACCOUNT_STATE_ENABLED) {

                                                        echo "<span>Группа активна</span>";

                                                    } else {

                                                        echo "<span>Группа заблокирована/span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    ...
                                                    if ($accountInfo['state'] == ACCOUNT_STATE_ENABLED) {
                                                        ...
                                                        ?>
                                                        <a class="" href="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=block">Блок Группы</a>
                                                        <?php

                                                    } else {

                                                        ?>
                                                        <a class="" href="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=unblock">Разблокировать</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($accountInfo['verify'] == 1) {
                                                        ...
                                                        ?>
                                                        <a class="" href="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=unverify">Не подтверждена</a>
                                                        <?php

                                                    } else {

                                                        ?>
                                                        <a class="" href="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=verify">Установить как подтвержденное</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
                                            ...
                                            <tr>
                                                <td>Всего сообщений в группе:</td>
                                                <td><?php echo $stats->getCommunityItemsTotal($accountInfo['id']); ?></td>
                                                <td></td>
                                            </tr>

                                            <tr>
                                                <td>Активные сообщения группы (не удаляются):</td>
                                                <td>
                                                    <?php
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ред. Группу</h4>
                                ...
                                <form class="form-material m-t-40" method="post" action="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Страница Instagram</label>
                                        <div class="col-md-12">
                            ...
                            <div class="card-block little-profile text-center">
                                ...
                                <?php
                                    ...
                                    if (strlen($accountInfo['lowPhotoUrl']) != 0) {
                                        ...
                                        ?>
                                            <a href="/admin/group/?id=<?php echo $accountInfo['id']; ?>&access_token=<?php echo admin::getAccessToken(); ?>&act=delete-photo">Удалить Фото</a>
                                        <?php
                                ...
                                <div class="row text-center m-t-20">
                                    ...
                                    <div class="col-lg-6 col-md-6 m-t-20">
                                        <h3 class="m-b-0 font-light"><?php echo $stats->getCommunityItemsCount($accountInfo['id']); ?></h3><small>Активные посты</small></div>
                                </div>
                            </div>
                        </div>
                        <!-- Column -->
