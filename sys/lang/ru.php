<?php
    ...
    $TEXT['main-page-welcome'] = "Публикуйте сообщения и картинки с помощью Rebirth Network!";

    $TEXT['main-page-about'] = "Rebirth Network - это социальная сеть с помощью которой Вы можете делиться интересными новостями, картинками и видеороликами с YouTube со своими друзьями и всеми людьми.";

    $TEXT['main-page-prompt-app'] = "Rebirth Network - Социальная Сеть для друзей";
    ...
    $TEXT['page-language'] = "Выберите язык";
    ...
    $TEXT['page-groups'] = "Группы";
    $TEXT['label-groups'] = "Группы";
    $TEXT['label-my-groups'] = "Мои Группы";
    $TEXT['label-managed-groups'] = "Управление";
    $TEXT['action-create-group'] = "Создать группу";
    $TEXT['label-group-search-prompt'] = "Искать группу по названию.";

    $TEXT['label-group-fullname'] = "Название";
    $TEXT['label-group-username'] = "Адрес страницы (Короткое имя)";
    $TEXT['label-group-status'] = "Описание группы";
    $TEXT['label-group-location'] = "Местоположение";
    $TEXT['label-group-web-page'] = "Веб-сайт";
    $TEXT['label-group-category'] = "Тематика группы";
    $TEXT['label-group-date'] = "Дата основания";
    $TEXT['label-group-privacy'] = "Настройки приватности";
    $TEXT['label-group-allow-comments'] = "Все члены группы имеют право оставлять записи на стене";
    $TEXT['label-group-allow-posts'] = "Все члены группы имеют право оставлять комментарии к сообщениям";

    $TEXT['label-group-name-error'] = "Имя (Короткое имя) уже занято или некорректно";
    $TEXT['label-group-fullname-error'] = "Полное имя группы должно содержать минимум 2 символа";
    ...
    $TEXT['page-balance-desc'] = "Монеты - это виртуальная валюта, которую вы можете использовать для обновления и других функций. Внимание! Пополнить баланс можно только с мобильного приложения Android или IOS. Откройте приложение с телефона и пополните свой баланс.";
    $TEXT['action-get-credits'] = "Получить монеты";
    $TEXT['label-credits'] = "Монеты";
    ...
    $TEXT['label-signup-sub-title'] = "Создайте аккаунт!";
    ...
    $TEXT['page-communities'] = "Группы";
    $TEXT['page-communities-description'] = "Группы за которыми вы следуете.";
    ...
    $TEXT['label-payments-credits'] = "Монеты";
    ...
    $TEXT['page-upgrades'] = "Премиум";
    $TEXT['page-upgrades-desc'] = "Получите больше с активацией дополнительных функций!";

    $TEXT['label-upgrades-verified-badge'] = "Синяя Галочка";
    $TEXT['label-upgrades-verified-badge-desc'] = "Покажите другим, что у Вас есть подтвержденный профиль с синей галочкой. Станьте крутым пользователем!";
    $TEXT['label-upgrades-ghost-mode'] = "Невидимка";
    $TEXT['label-upgrades-ghost-mode-desc'] = "Просматривайте профили пользователей анонимно, пользователи не будут знать и получать уведомления, когда вы посещаете их профиль.";
    $TEXT['label-upgrades-off-admob'] = "Убрать рекламу";
    $TEXT['label-upgrades-off-admob-desc'] = "Мешает реклама? Уберите ее!";

    // For version 5.2

    $TEXT['page-market'] = "Магазин";
    ...
    $TEXT['label-menu-post'] = "Опубликовать";
    $TEXT['label-menu-item'] = "Опубликовать";
    ...
    $TEXT['page-explore'] = "Посмотреть";

    $TEXT['action-explore'] = "Посмотреть";

    $TEXT['main-page-promo-google-app'] = "%s Социальная Сеть для друзей. Создавайте посты, общайтесь, вступайте в группы, делитесь информацией, знакомьтесь.";
    $TEXT['main-page-promo-login'] = "%s - Присоединяйтесь к нам!";
    $TEXT['main-page-promo-explore'] = "%s - Социальная Сеть где можно общаться по душам! Нажмите посмотреть, чтобы войти под гостем";